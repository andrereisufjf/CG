...
import { criarAviao, } from "./modelo_aviao.js"
import { keyboardUpdate, movePlane, initMov } from "./movimentacao.js";
...
var plane = createGroundPlaneWired(5000, 5000, 100, 100);
// add the plane to the scene
scene.add(plane);

var aviao = criarAviao();
aviao.name = 'aviao';

var objetoVirtual = new THREE.Object3D();
objetoVirtual.add(camera);
objetoVirtual.add(aviao);
